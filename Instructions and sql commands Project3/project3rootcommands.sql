...
# Project3 database (supplier/parts/jobs/shipments.  The Java servlet that is 
# Project3 incoporates server-side business logic that manipulates the status of a
...
# Command 3D: add a new record to shipments table (S39, P3, J1, 20), business logic will trigger but no status marks updated in 
# the bonus version and 9 status marks will be updated in the non-bonus version.
