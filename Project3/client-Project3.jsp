...
<body>
    ...
    <section style="justify-content: center; text-align: center;">
        ...
        <hr>
        <p>
            <h3>You are connected to the Project 3 Enterprise System Database as a <span style="color:red ;">Client-Level</span> user.</h3>
            <h3>Please enter any valid SQL Query command in the box below.</h3>
        </p>
        <form method="post" action="/Project3/client2" >
